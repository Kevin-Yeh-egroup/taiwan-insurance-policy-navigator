...
from extract_tii_plan_benefits import (
    FUBON_GROUP_ONE_YEAR_INPATIENT_DAILY_PRODUCT_IDS,
    FUBON_GROUP_ONE_YEAR_INPATIENT_DAILY_VERSIONS,
    complete_strict_source_document,
    parse_fubon_group_one_year_inpatient_daily_policy_state,
...
PROPOSAL_PATH = (
    ...
    / "tii-life-050-fubon-group-one-year-inpatient-daily-v247.json"
)
PARSER_ID = (
    "fubon-group-one-year-inpatient-daily-policy-state-v1"
)


def source_document(product_id: str) -> tuple[dict, Path]:
    version = FUBON_GROUP_ONE_YEAR_INPATIENT_DAILY_VERSIONS[
        product_id
    ]
    source_path = (
...
def assert_invalid_schedule(
    ...
    try:
        validate_plan_options(
            schedule,
            "negative/tii-life-050/fubon-group-inpatient-daily",
        )
...
assert (
    schedules["209317R11A00103"]["version_characteristics"][
        "source_product_id"
    ]
    != schedules["209317R11A00104"]["version_characteristics"][
        "source_product_id"
    ]
)

wrong_phase = copy.deepcopy(schedules["209317R11A00106"])
...
wrong_cap_key = copy.deepcopy(
    schedules["209313RZ1A00121A11Z10000015"]
)
...
wrong_hash = copy.deepcopy(schedules["209317R11A00100"])
...
bad_document, _ = source_document("209317R11A00100")
