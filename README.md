...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 50 attempted manual batches, 1 waiting on captcha, 49 indexed manual batches, 49 complete manual batches, 68,659 imported TII policy records, 68,414 saved detail pages, and 245 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `50` attempted manual batches, `1` waiting on captcha, `49 / 306` indexed manual batches, `49 / 306` complete manual batches, `68,659` imported TII policy records, `68,414 / 68,659` saved detail pages, and `245` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-049`. Latest completed batches: `tii-property-048` completed with `3,630 / 3,630` official rows, `2,906` product cards, `724` duplicate official product-id rows, and `2,872 / 2,906` saved detail pages, with `34` detail pages marked for later backfill; `tii-property-049` completed with `1,273 / 1,273` official rows, `1,273` product cards, and `1,273 / 1,273` saved detail pages. `tii-property-050` is prepared and waiting for a fresh human-entered captcha. The remaining `257` TII batches still require fresh operator captcha sessions.
