...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 27 attempted manual batches, 1 waiting on captcha, 26 indexed manual batches, 26 complete manual batches, 37,045 imported TII policy records, 36,919 saved detail pages, and 126 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `27` attempted manual batches, `1` waiting on captcha, `26 / 306` indexed manual batches, `26 / 306` complete manual batches, `37,045` imported TII policy records, `36,919 / 37,045` saved detail pages, and `126` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-026`. Latest completed batches: `tii-property-025` completed with `1,156 / 1,156` official rows, `1,156` product cards, and `1,156 / 1,156` saved detail pages; `tii-property-026` completed with `610 / 610` official rows, `610` product cards, and `605 / 610` saved detail pages. `tii-property-027` is prepared and waiting for a fresh human-entered captcha. The remaining `280` TII batches still require fresh operator captcha sessions.
