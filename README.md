...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 24 attempted manual batches, 1 waiting on captcha, 23 indexed manual batches, 23 complete manual batches, 33,879 imported TII policy records, 33,758 saved detail pages, and 121 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `24` attempted manual batches, `1` waiting on captcha, `23 / 306` indexed manual batches, `23 / 306` complete manual batches, `33,879` imported TII policy records, `33,758 / 33,879` saved detail pages, and `121` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-023`. Latest completed batches: `tii-property-022` completed with `706 / 706` official rows, `706` product cards, and `705 / 706` saved detail pages; `tii-property-023` completed with `846 / 846` official rows, `846` product cards, and `844 / 846` saved detail pages. `tii-property-024` is prepared and waiting for a fresh human-entered captcha. The remaining `283` TII batches still require fresh operator captcha sessions.
