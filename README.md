...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 57 attempted manual batches, 1 waiting on captcha, 56 indexed manual batches, 56 complete manual batches, 77,444 imported TII policy records, 76,268 saved detail pages, and 1,176 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `57` attempted manual batches, `1` waiting on captcha, `56 / 306` indexed manual batches, `56 / 306` complete manual batches, `77,444` imported TII policy records, `76,268 / 77,444` saved detail pages, and `1,176` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-056`. Latest completed batches: `tii-property-055` completed with `853 / 853` official rows, `853` product cards, and `852 / 853` saved detail pages, with `1` detail page marked for later backfill; `tii-property-056` completed with `3,456 / 3,456` official rows, `3,001` product cards, `455` official duplicate product-id rows, and `2,997 / 3,001` saved detail pages, with `4` detail pages marked for later backfill. `tii-property-057` is prepared and waiting for a fresh human-entered captcha. The remaining `250` TII batches still require fresh operator captcha sessions.
