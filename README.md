...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 42 attempted manual batches, 1 waiting on captcha, 41 indexed manual batches, 41 complete manual batches, 56,174 imported TII policy records, 55,985 saved detail pages, and 189 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `42` attempted manual batches, `1` waiting on captcha, `41 / 306` indexed manual batches, `41 / 306` complete manual batches, `56,174` imported TII policy records, `55,985 / 56,174` saved detail pages, and `189` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-041`. Latest completed batches: `tii-property-040` completed with `40 / 40` official rows, `40` product cards, and `40 / 40` saved detail pages; `tii-property-041` completed with `1,131 / 1,131` official rows, `1,131` product cards, and `1,131 / 1,131` saved detail pages. `tii-property-042` is prepared and waiting for a fresh human-entered captcha. The remaining `265` TII batches still require fresh operator captcha sessions.
