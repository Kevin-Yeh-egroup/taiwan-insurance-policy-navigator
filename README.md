...
- TII manual batches follow the site split: 108 property-insurance batches and 198 life/personal-insurance batches, 306 total. Current TII execution/import status is 48 attempted manual batches, 1 waiting on captcha, 47 indexed manual batches, 47 complete manual batches, 64,480 imported TII policy records, 64,269 saved detail pages, and 211 detail pages marked for later backfill.
...
Current TII manual matrix: `27` property insurers x `4` property categories = `108` batches; `33` life/personal insurers x `6` personal-insurance categories = `198` batches; total `306` manual batches. These batches are shown on the site as clickable property/life groups, but captcha still requires human input. Current status is `48` attempted manual batches, `1` waiting on captcha, `47 / 306` indexed manual batches, `47 / 306` complete manual batches, `64,480` imported TII policy records, `64,269 / 64,480` saved detail pages, and `211` detail pages marked for later backfill. Completed range: `tii-property-001` through `tii-property-047`. Latest completed batches: `tii-property-046` completed with `677 / 677` official rows, `677` product cards, and `672 / 677` saved detail pages, with `5` detail pages marked for later backfill; `tii-property-047` completed with `1,289 / 1,289` official rows, `1,289` product cards, and `1,287 / 1,289` saved detail pages, with `2` detail pages marked for later backfill. `tii-property-048` is prepared and waiting for a fresh human-entered captcha. The remaining `259` TII batches still require fresh operator captcha sessions.
